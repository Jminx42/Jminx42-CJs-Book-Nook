    ...
    return (
        <div className="container">
            ...
            <div className="row mb-2">
                ...
                <div className="col-sm-3 col-md-3 col-lg-3 d-flex h-25 justify-content-center align-items-center">
                ...
                <div className="col-sm-3 col-md-3 col-lg-3 h-25 align-items-center">
