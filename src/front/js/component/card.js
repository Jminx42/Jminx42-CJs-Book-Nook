...
export const Card = ({ item }) => {
    ...
    return (
        ...
        <div className="card mx-2" style={{ width: "18rem" }}>
            <img src={item.profile} className="card-img-top" alt="..." />
            <div className="card-body" style={{ height: "250px", position: "relative" }}>

                <h5 className="card-text text-start">Gender: {item.title}</h5>
                <p className="card-text text-start">Status: {item.author}</p>
